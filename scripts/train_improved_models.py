"""Train the Step 6 improved models."""
...
from src.models.train_improved_model import train_improved_models  # noqa: E402
...
def main() -> None:
    ...
    print(f"Improved metrics path: {summary.get('improved_metrics_path')}")
    print(f"Backtest path: {summary.get('backtest_results_path')}")
    print(f"Probability quality report path: {summary.get('probability_quality_report_path')}")
