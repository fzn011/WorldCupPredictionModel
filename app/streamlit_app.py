...
_pg = st.navigation(
    {
        ...
        "Advanced": [
            st.Page("pages/4_Model_Explanation.py", title="Model Explanation", icon="🔬"),
            st.Page("pages/5_Tournament_Setup.py", title="Tournament Setup", icon="⚙️"),
            st.Page("pages/6_Group_Stage_Simulation.py", title="Group Stage", icon="📋"),
            st.Page("pages/7_Knockout_Simulation.py", title="Knockout", icon="⚡"),
            st.Page("pages/8_Full_Tournament_Run.py", title="Full Tournament Run", icon="🎯"),
            st.Page("pages/11_Official_Data_Health.py", title="Official Data", icon="📂"),
            st.Page("pages/12_Official_Squads_Health.py", title="Squads Health", icon="👥"),
            st.Page("pages/13_Official_Final_Readiness.py", title="Final Readiness", icon="🔒"),
            st.Page("pages/14_Official_Data_Population.py", title="Data Population", icon="📝"),
            st.Page(
                "pages/15_Source_Assisted_Population.py",
                title="Source Population",
                icon="🔗",
            ),
            st.Page(
                "pages/16_Official_Data_Population_Completion.py",
